// на момент инсталла @types/mongoose-paginate-v2 там была ts-ошибка
// https://github.com/DefinitelyTyped/DefinitelyTyped/issues/44404#issue-610513070
// так что dirty fix вот:
